...
import { useGetTodoMutation } from "../slices/todoApiSlice";
  ...
  return (
    <form className="bg-gray-50 p-4 rounded-lg shadow-md border border-gray-200" onSubmit={submitHandler}>
      ...
      <div className="space-y-4">
        ...
        <button type="submit" className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-2 rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-transform">
